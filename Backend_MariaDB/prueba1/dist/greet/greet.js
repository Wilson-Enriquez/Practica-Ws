...
import { Greet } from "../greet/greet.mariadb.js"; // Importa la clase Greet que maneja la base de datos
...
greet.post("/greet", async (c) => {
    ...
    const result = await Greet.create(param); // Crear el saludo en la base de datos
